...
describe("Prueba unitaria de filtro", () => {
  ...
  it("Retorna el arreglo de los personajes especificados", () => {
  expect(filterAll("status", "Dead", people)).toEqual(peopleDead);
  });
});

const nameData=[ {"name":"Elsy"},{"name":"Celeste"}, {"name":"Tom"}, {"name":"Adrian"}];
const name2= [{"name":"Adrian"},{"name":"Celeste"}, {"name":"Elsy"}, {"name":"Tom"}];
const name3= [{"name":"Tom"},{"name":"Elsy"}, {"name":"Celeste"}, {"name":"Adrian"}];
